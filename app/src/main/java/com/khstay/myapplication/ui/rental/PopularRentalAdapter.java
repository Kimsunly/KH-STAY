...
public class PopularRentalAdapter extends RecyclerView.Adapter<PopularRentalAdapter.ViewHolder> {
    ...
    public PopularRentalAdapter(List<Rental> rentals) { this.rentals = rentals; }
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, int position) {
        ...
        h.tvPrice.setText("$" + (r.getPrice() != null ? r.getPrice().intValue() : 0) + " /month");
        ...
        h.itemView.setOnClickListener(v -> {
            if (r.getId() == null || r.getId().isEmpty()) return; // safety if id not set yet
